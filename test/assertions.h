...
#define RC_ASSERT_TENSOR_EQ_1D(result, ...) RC_ASSERT(assertEqual1d(result, __VA_ARGS__) == ::testing::AssertionSuccess())
...
#define RC_ASSERT_TENSOR_EQ_2D(result, ...) RC_ASSERT(assertEqual2d(result, __VA_ARGS__) == ::testing::AssertionSuccess())
